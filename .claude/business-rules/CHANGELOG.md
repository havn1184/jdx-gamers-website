...
> Phiên bản hiện tại: **v1.2.0** (2026-09-02)
>
...
|---|---|---|---|
| 2026-09-02 | v1.2.0 | Sửa mô tả sai "chưa có backend thật/frontend + mock 100%" (BE JGameApi đã tích hợp thật hầu hết nghiệp vụ, chỉ còn tích hợp đối tác ngoài jPay/J-Invoice/Zalo ZNS/NCC/NetBarBox chưa có) - thêm bảng ánh xạ Giai đoạn (GĐ) ↔ phân hệ - thêm dòng "Xem thêm" trỏ system-architect cho cho-ve-cybergame.md/phu-kien-gamer.md/quan-tri-admin.md | 00-tong-quan.md, cho-ve-cybergame.md, phu-kien-gamer.md, quan-tri-admin.md |
