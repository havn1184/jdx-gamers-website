...
/** Mỗi sản phẩm có 3 ảnh minh hoạ (ảnh chính + 2 góc/chi tiết khác), sưu tầm cùng chủng loại
 * từ kho ảnh miễn phí Pexels — hiển thị dạng thumbnail chọn ảnh ở trang chi tiết (kiểu Shopee). */
export const MOCK_ACCESSORY_PRODUCTS: AccessoryProduct[] = [
  {
    id: 'mouse-logitech-g502', sku: 'PK-MOUSE-LOGI-G502', name: 'Chuột Logitech G502 HERO', category: 'mouse', brand: 'Logitech',
  ...
  {
    id: 'keyboard-corsair-k70', sku: 'PK-KEYB-CORS-K70', name: 'Bàn phím cơ Corsair K70 RGB', category: 'keyboard', brand: 'Corsair',
    ...
    galleryImages: [
      ...
      'https://images.pexels.com/photos/920631/pexels-photo-920631.jpeg?auto=compress&cs=tinysrgb&w=600',
    ],
    art: { gradient: ['#F97316', '#EF4444'], icon: 'Keyboard' },
  },
  {
    id: 'keyboard-razer-huntsman-mini', sku: 'PK-KEYB-RAZER-HM', name: 'Bàn phím cơ Razer Huntsman Mini', category: 'keyboard', brand: 'Razer',
  ...
  {
    id: 'headset-steelseries-arctis7', sku: 'PK-HEAD-STSR-A7', name: 'Tai nghe SteelSeries Arctis 7', category: 'headset', brand: 'SteelSeries',
    ...
    galleryImages: [
      'https://images.pexels.com/photos/18441496/pexels-photo-18441496.jpeg?auto=compress&cs=tinysrgb&w=600',
      'https://images.pexels.com/photos/28993111/pexels-photo-28993111.jpeg?auto=compress&cs=tinysrgb&w=600',
    ],
    art: { gradient: ['#10B981', '#22D3EE'], icon: 'Headphones' },
  },
  {
    id: 'headset-hyperx-cloud2', sku: 'PK-HEAD-HYPX-C2', name: 'Tai nghe HyperX Cloud II', category: 'headset', brand: 'HyperX',
  ...
  {
    id: 'gpu-nvidia-rtx4070', sku: 'PK-GPU-NVDA-4070', name: 'Card đồ họa NVIDIA GeForce RTX 4070', category: 'gpu', brand: 'NVIDIA',
    ...
    galleryImages: [
      'https://images.pexels.com/photos/18338417/pexels-photo-18338417.jpeg?auto=compress&cs=tinysrgb&w=600',
  ...
  {
    id: 'gpu-amd-rx7800xt', sku: 'PK-GPU-AMD-7800XT', name: 'Card đồ họa AMD Radeon RX 7800 XT', category: 'gpu', brand: 'AMD',
  ...
  {
    id: 'pc-asus-rog-strix', sku: 'PK-PC-ASUS-ROGSTRIX', name: 'PC Gaming ASUS ROG Strix', category: 'pc', brand: 'ASUS ROG',
    ...
    galleryImages: ['https://images.pexels.com/photos/13071304/pexels-photo-13071304.jpeg?auto=compress&cs=tinysrgb&w=600'],
    art: { gradient: ['#1E293B', '#7C3AED'], icon: 'Cpu' },
  },
  {
    id: 'monitor-samsung-odyssey', sku: 'PK-MON-SSNG-G7', name: 'Màn hình Samsung Odyssey G7 27"', category: 'monitor', brand: 'Samsung',
    ...
    galleryImages: ['https://images.pexels.com/photos/1383833/pexels-photo-1383833.jpeg?auto=compress&cs=tinysrgb&w=600'],
    art: { gradient: ['#3B82F6', '#1E293B'], icon: 'Monitor' },
  },
  {
    id: 'chair-secretlab-titan', sku: 'PK-CHAIR-SCLB-TITAN', name: 'Ghế Gaming Secretlab Titan Evo', category: 'chair', brand: 'Secretlab',
    ...
    galleryImages: [
      'https://images.pexels.com/photos/7862508/pexels-photo-7862508.jpeg?auto=compress&cs=tinysrgb&w=600',
      'https://images.pexels.com/photos/4317157/pexels-photo-4317157.jpeg?auto=compress&cs=tinysrgb&w=600',
    ],
    art: { gradient: ['#EF4444', '#7C3AED'], icon: 'Armchair' },
  },
  {
    id: 'chair-dxracer-formula', sku: 'PK-CHAIR-DXR-FORMULA', name: 'Ghế Gaming DXRacer Formula', category: 'chair', brand: 'DXRacer',
